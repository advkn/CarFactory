/*This example uses a virtual constructor to build a car in the factory that has
the fewest cars in production.
To do this, we use a function ('getLeastBusyFactory') that looks at several factories and chooses the least 
busy one.
*/
...
int main() {
	...
	//Declare an empty vector of factories
	...
	//To get some more interesting results, preorder some cars.
	factory1->requestCar();
	factory2->requestCar();
	factory3->requestCar();
	factory4->requestCar();
